	...
	public static void main(String[] args)
		...
		try {
			...
			BankData = new CsvToBeanBuilder<BankData>(
					new FileReader("C:\\Users\\SNESHARM\\eclipse-workspace\\MatchChecker-main\\MatchChecker-main\\Resources\\Bank.csv")).withType(BankData.class)
							.withSkipLines(1).build().parse();

			//Reading ClientData.csv file using openCSV parser
			ClientData = new CsvToBeanBuilder<ClientData>(
					new FileReader("C:\\Users\\SNESHARM\\eclipse-workspace\\MatchChecker-main\\MatchChecker-main\\Resources\\EmployeeDetails.csv"))
			...
			Writer outputFile = new FileWriter("C:\\Users\\SNESHARM\\eclipse-workspace\\MatchChecker-main\\MatchChecker-main\\ComparisonData.csv");
